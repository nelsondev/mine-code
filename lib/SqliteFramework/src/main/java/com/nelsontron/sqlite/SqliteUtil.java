 ...
 * Everything works in an extremely object oriented matter relying on Object model objects. This is a static
 * utility library made for the sqlite database class to call from, but also to provide functionality to the project if
 * custom queries need to be executedS.
 */
public class SqliteUtil {
    ...
    private static String getFormattedId(Object obj) throws NoSuchFieldException, IllegalAccessException {
     ...
     */
    public static Object getUnAccessible(String name, Object obj) throws NoSuchFieldException, IllegalAccessException {
    ...
    public static <T> T select(String url, String table, T obj) {
        T result = null;
        try {
    ...
    public static void insert(String url, String table, Object obj) {
        String sql = null;
        try {
            sql = "INSERT OR REPLACE INTO " + table + "("
                    + SqliteSerializable.toKeySet(obj)
                    + ") VALUES ("
                    + SqliteSerializable.toValueSet(obj)
                    + ");";
    ...
    public static void insert(String url, String table, List<Object> list) {
        for (Object o : list) {
            insert(url, table, o);
        }
    }

    public static void update(String url, String table, Object obj) {
        String sql = null;
        try {
            String set = SqliteSerializable.toKeyValueSet(obj, false);
    ...
    public static void update(String url, String table, String where, Object obj) {
        String sql = null;
        try {
            sql = "UPDATE " + table +
                    " SET " + SqliteSerializable.toKeyValueSet(obj, false) +
                    " WHERE " + where + ";";
            updateReferences(url, table, obj);
        } catch (IllegalAccessException e) {
            e.printStackTrace();
    ...
    public static void update(String url, String table, List<Object> list) {
        for (Object obj : list) {
            update(url, table, obj);
        }
    }
    public static void updateReferences(String url, String table, Object obj) {
        for (Field field : obj.getClass().getDeclaredFields()) {
            ...
            try {
                ...
                for (Object o : temp) {
                    ...
                    delete(url, refTable, (Object) o);
                }

                // update records
                for (Object updating : list) {
    ...
    public static void updateOrInsert(String url, String table, Object obj) {
    ...
    public static void delete(String url, String table, Object obj) {
        try {
    ...
    public static void delete(String url, String table, List<Object> list) {
        for (Object obj : list) {
